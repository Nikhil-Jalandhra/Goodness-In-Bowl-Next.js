const blogData = [
    ...
    },
    {
        ...
        description3: "Try recipes like cucumber-mint infused water, berry smoothie bowls, or herbal iced teas. These refreshing options can help you stay hydrated while enjoying delicious flavors. Incorporating these recipes into your lifestyle can significantly increase your fluid intake while providing nourishment. Hydration doesn't have to be boring—by experimenting with different ingredients and presentation, you can transform how you view hydration and create a habit that supports your health and wellness goals.",
